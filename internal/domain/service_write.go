...
// classifier (update), and the audit-carrying ApplyService.
...
// NewServiceWriteService builds the service.
func NewServiceWriteService(base ServiceBaseBuilder, get ServiceGetter, apply *ApplyService, defaultNamespace string) *ServiceWriteService {
	return &ServiceWriteService{base: base, get: get, apply: apply, defaultNamespace: defaultNamespace}
}
